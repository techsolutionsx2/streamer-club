        ...
        <Col item={12}>
          <Row flexDirection="column">
            <Row alignItems="center">
              <CustomText strong css={{fontSize: "0.906rem"}}>
                {"Current Club: "}
              </CustomText>
              <CustomText strong css={{ marginLeft: "8px" }}>{player.club.name}</CustomText>
            </Row>
          </Row>
        </Col>
        <Col item={12}>
              ...
              {!flag ? (
                player.teams.map((team: { name: string }, idx: number) => (
                  <Button
                    ...
                    bColor="warning"
                    disabled={isSubmit}
                    style={{marginLeft: "8px", fontSize: "0.906rem"}}
                  >
                    {team.name}
                  </Button>
                ))
      ...
      <Row gap={50} alignItems="center" justifyContent="center">
        <Col item={12}>
          <Row alignItems="center">
              ...
              {!flag ? (
                <CustomText strong css={{ marginLeft: "8px" }}>{player.positions && player.positions.join(", ")}</CustomText>
              ) : (
